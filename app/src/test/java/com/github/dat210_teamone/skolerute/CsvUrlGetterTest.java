...
import com.github.dat210_teamone.skolerute.data.CsvUrlGetter;
...
public class CsvUrlGetterTest {
    ...
    public void TestGetFileUrl(){
        String url = CsvUrlGetter.getFileUrl("http://open.stavanger.kommune.no/dataset/skoler-stavanger");
        ...
        String url2 = CsvUrlGetter.getFileUrl("http://open.stavanger.kommune.no/dataset/skolerute-stavanger");
